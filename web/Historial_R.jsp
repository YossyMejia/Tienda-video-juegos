<%-- 
    Document   : Historial_R
    Created on : 16/10/2020, 06:13:25 PM
    Author     : XPC
--%>
...
<html>
    ...
    <body class="bodyb">
        <div class="container">
            ...
            <hr>
            <form action="./RepartidorHistorial" method="post">
             <div class="scrollit">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn-default" name="idOrdenEntregado"  value=<%=lista.get(i).getId_orden()%>>Establecer como entregado</button>
                    </td>
                </tr> 
                <%}%>
               <%}%>
